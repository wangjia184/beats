...
https://github.com/wangjia184/beats/blob/master/metricbeat/scripts/module/metricset/metricset.go.tmpl
...
https://godoc.org/github.com/wangjia184/beats/libbeat/common#MapStr[MapStr API docs].
...
https://godoc.org/github.com/wangjia184/beats/libbeat/common/schema[schema] package
