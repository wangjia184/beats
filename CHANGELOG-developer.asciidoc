...
https://github.com/wangjia184/beats/compare/v6.3.0..v7.0.0-alpha2[Check the HEAD diff]
...
- Dashboards under _meta/kibana are expected to be decoded. See https://github.com/wangjia184/beats/pull/7224 for a conversion script. {pull}7265[7265]
- Constructor `(github.com/wangjia184/beats/libbeat/output/codec/json).New` expects a new `escapeHTML` parameter. {pull}7445[7445]
