...
```
  $ cd ${GOPATH}/src/github.com/wangjia184/beats/packetbeat
  $ python ${GOPATH}/src/github.com/wangjia184/beats/packetbeat/scripts/create_tcp_protocol.py
```

Load plugin into packetbeat by running `make update`. Or add `_
"github.com/wangjia184/beats/packetbeat/protos/echo"` to the import list in
`$GOPATH/src/github.com/wangjia184/beats/packetbeat/include/list.go`.
